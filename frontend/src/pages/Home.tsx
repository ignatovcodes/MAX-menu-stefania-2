  ...
  return (
    <div className="min-h-screen bg-dark-bg flex flex-col items-center justify-center px-6 pb-24">
      <div className="text-center mb-12">
        <div className="w-24 h-24 mx-auto mb-6 rounded-2xl bg-gold/20 flex items-center justify-center">
          <span className="text-4xl font-bold text-gold">S</span>
        </div>
        <h1 className="text-3xl font-bold text-white mb-2">Stephania</h1>
        <p className="text-gray-400">Ресторан итальянской и кавказской кухни</p>
      </div>
      ...
      <div className="w-full max-w-md space-y-4">
        {cards.map((card) => (
          ...
          >
            <div className="w-14 h-14 rounded-xl bg-gold/10 flex items-center justify-center text-gold group-hover:bg-gold/20 transition-colors">
              {card.icon}
            </div>
